 ...
 * All functions gracefully return null if the client doesn't support
 * elicitation — elicitation is purely additive and never blocks a tool call.
 */
 ...
 * Returns true/false for an explicit answer, or null when the client does
 * not support elicitation (callers decide how to proceed on null).
 */
